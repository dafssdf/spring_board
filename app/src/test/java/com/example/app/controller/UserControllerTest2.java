...
@Slf4j
//spring Mvc테스트를 진행하기 위한 어노테이션 테스트를 진행하려는 클래스의 정보를 매개변수로 넘겨준다.
...
//        is3xxRedirection() : 응답의 상태코드가 300번대 리다이렉트 인지 확인
//
        mockMvc.perform(post("/user/join")
                .param("userId","aaa")
                .param("userPassword","1234")
        ).andExpect(MockMvcResultMatchers.status().is3xxRedirection()) //검증 andExpect()
